...
urlpatterns = [
    ...
    path('/<int:pk>/update/',
         UpdateEvt.as_view(template_name='update.html'), name="update"),
    path('/AjoutGeneric/', Ajout.as_view()),
    path('/supprimer/<int:id>/', SupprimerEvt, name='supprimer'),
    path('/login', LoginView.as_view(template_name='login.html'), name="login"),
    path('/logout', LogoutView.as_view(template_name='logout.html'), name="logout"),
    path('/participate/<int:evt_id>', Participate, name="Participate"),
    path('/cancel/<int:id>', cancelParticipation, name="CancelParticipation"),
